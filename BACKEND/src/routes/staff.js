...
const { getFilteredStudents, getAllMajors2, getAllLecturers, reassignClass, getAllClasses } = require('../controllers/staff');
...
router.put('/classes/:classId/reassign', reassignClass);
